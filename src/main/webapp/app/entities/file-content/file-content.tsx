...
export const FileContent = (props: IFileContentProps) => {
  ...
  const { fileContentList, match, loading } = props;
  return (
    <div>
      <h2 id="file-content-heading">
        <Translate contentKey="jhipsterSampleApplicationApp.fileContent.home.title">File Contents</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterSampleApplicationApp.fileContent.home.createLabel">Create new File Content</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {fileContentList && fileContentList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {fileContent.fileDataContent ? (
                      <div>
                        <a onClick={openFile(fileContent.fileDataContentContentType, fileContent.fileDataContent)}>
                          <Translate contentKey="entity.action.open">Open</Translate>
                          &nbsp;
                        </a>
                        <span>
                          {fileContent.fileDataContentContentType}, {byteSize(fileContent.fileDataContent)}
                        </span>
                      </div>
                    ) : null}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationApp.fileContent.home.notFound">No File Contents found</Translate>
            </div>
          )
        )}
      </div>
